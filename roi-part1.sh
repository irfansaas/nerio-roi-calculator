...
# Create ROI types file
cat > src/types/roi.types.ts << 'EOF'
...
# Create ROI calculation utilities
cat > src/utils/roiCalculations.ts << 'EOF'
...
echo "Part 1 completed: Types and utilities created"